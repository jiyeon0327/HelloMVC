...
<section id="notice-container">
        ...
        <script>
        	...
        	$(function(){
        		$("#btn-add").click(function(){
        			location.href="<%=request.getContextPath()%>/notice/noticeWriter";
        		});
        	});
        </script>
	...
	<% for(Notice n:list) {%>
		<tr>
			...
			<%-- <td onclick="location.href = '<%=request.getContextPath()%>/notice/noticeClick?notice_no=<%=n.getNotice_No()%>'"><%=n.getNotice_Title()%></td> --%>
			<td>
				<a href="<%=request.getContextPath()%>/notice/noticeClick?notice_No=<%=n.getNotice_No()%>"><%=n.getNotice_Title()%></a>
			</td>
